...
def get_os_release():
    ...
    if os_release_info is not None:
        ...
        if 'ALEXELEC_PROJECT' in os_release_info:
            project = os_release_info['ALEXELEC_PROJECT']
        if 'ALEXELEC_DEVICE' in os_release_info:
            device = os_release_info['ALEXELEC_DEVICE']
