...
URL_MAIN="https://github.com/AlexELEC/Puzzle4-pkg/releases/download"
URL_LAST="https://github.com/AlexELEC/Puzzle4-pkg/releases/latest"
...
# clean DB
      ...
      mv -f $PTV_DIR/logo $PTV_DIR/logo.bk
